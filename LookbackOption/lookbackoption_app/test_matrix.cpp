...
namespace lookback {
	void test_matrix() {
		std::cout << "Testing Matrix constructor\n";
		Matrix m1{ 3,3 };
		...
		std::cout << "Matrix constructor OK and exceptions thrown\n";

		std::cout << "Testing Matrix output operator\n";
		std::cout << m1 << '\n';
		std::cout << m2 << '\n';
		std::cout << m3;
		std::cout << "Matrix output operator OK\n";

		std::cout << "Testing Matrix getters\n";
		std::cout << m1.get_M() << ' ' << m1.get_N() << '\n';
		std::cout << m2.get_M() << ' ' << m2.get_N() << '\n';
		std::cout << m3.get_M() << ' ' << m3.get_N() << '\n';
		std::cout << "Matrix getters OK\n";

		std::cout << "Testing Matrix parenthesis element overload\n";
		std::cout << m1(0, 2) << '\n';
		std::cout << m3(1, 1) << '\n';
		std::cout << m1(0, 0) << '\n';
		std::cout << m3(3, 1) << '\n';
		...
		//std::cout << m1(-1, 1) << '\n'; //exception thrown
		//std::cout << m3(0, 4) << '\n'; //exception thrown
		std::cout << "Matrix parenthesis element overload OK and exceptions thrown\n";

		std::cout << "Testing Matrix parenthesis row overload\n";
		...
		std::cout << "Matrix parenthesis row overload OK and exceptions thrown\n";
		std::cout << "Testing Matrix construction time wrt M,N values\n";
		std::cout << '\n' << '\n';
